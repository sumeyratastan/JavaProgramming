...
//yes,Yes,YES,yEs.......
        ...
        boolean hasJava3=sentence.toLowerCase().contains("java");//IMPORTANT....
...
boolean r3= sentence.contains("java") || sentence.contains("Java");//jAvA
        ...
        boolean z=a.toLowerCase().startsWith("wooden");//in order the ignore the sensitivity we first create the
