...
public class GradeCalculator {
    public static void main(String[] args) {
       ...
       gradeOfB.removeIf(p->!(p>=80&&p<=89));
        ...
        System.out.println("Total number of GradeA: "+gradeOfA.size());
        System.out.println("Total number of GradeB: "+gradeOfB.size());
        System.out.println("Total number of GradeC: "+gradeOfC.size());
        System.out.println("Total number of GradeD: "+gradeOfD.size());
        System.out.println("Total number of GradeF: "+gradeOfF.size());
