...
public class StatusCode {
    public static void main(String[] args) {
      ...
      ||statusCode==307||statusCode==400||statusCode==401||statusCode==403||statusCode==404||statusCode==410
              ||statusCode==500||statusCode==503){

         validStatus= (statusCode==200)?"OK":(statusCode==201)?"Created":(statusCode==202)?"Accepted"
          ...
          validStatus="please enter valid code";
      }
